...
// // your data.
exports.typeDefs = [ Query, Mutation, ProjectFeed, Projects, Project, Technology, User, Role ];

// Resolvers define the technique for fetching the types defined in the
// schema. This resolver retrieves books from the "books" array above.
exports.resolvers = merge(projectFeedResolvers, projectResolvers, projectsResolvers);
